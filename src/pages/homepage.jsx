              ...
              <div className="homepage-first-area-left-side">
                ...
                <div className="static-description">
                  {highlightText(INFO.homepage.staticDescription, 
                    ["computational political communication", "authoritarian politics", "AI governance", "Perspectives on Politics", "China Review", "China Perspectives", "Journal of Public and Nonprofit Affairs"],
                    [
